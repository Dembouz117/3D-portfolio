...
const Project = ({props}: any) => {
  ...
  const background = useRef<Mesh<BufferGeometry, Material | Material[], Object3DEventMap>>(null); // Use BufferGeometry directly
  ...
  useFrame(() => {
    if (background.current) {
      const material = background.current.material as THREE.MeshBasicMaterial; // Cast to MeshBasicMaterial
